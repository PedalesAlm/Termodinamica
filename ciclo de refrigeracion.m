...
l=A(:,12);
m=A(:,13);
disp('Buen dia este programa le ayudara a determinar la potencia de un condensador y un evaporador,');
disp('tambien la potencia de un compresor en un ciclo de refrigeracion ');
...
disp('tenga la amabilidad de digitar la siguiente informacion');
disp('estado 1');
disp('entalpia a partir de la presion-->1');
disp('entalpia a partir de la temperatura-->2');
menu=input('');
 if menu==1
Presion=input('digite el valor de la presion en psia');
interpolar=interp1(b,j,Presion,'spline');
disp('su entalpia en Btu/lbm es');
disp(interpolar);
elseif menu==2
...
if menu==1
Presion=input('digite el valor de la presion en psia');
interpolar2=interp1(b,j,Presion,'spline');
disp('su entalpia en Btu/lbm es');
disp(interpolar2);
elseif menu==2
    Temperatura=input('digite el valor de la temperatura en °F');
    interpolar3=interp1(a,j,Temperatura,'spline');
    disp('su entalpia en Btu/lbm es');
    disp(interpolar3);    
end
disp('estado 3');
...
menu=input('');
if menu==1
Presion=input('digite el valor de la presion psia');
interpolar4=interp1(b,h,Presion,'spline');
disp('su entalpia en Btu/lbm es');
disp(interpolar4);
elseif menu==2
    Temperatura=input('digite el valor de la temperatura en °F');
    interpolar5=interp1(a,h,Temperatura,'spline');
    disp('su entalpia en Btu/lbm es');
    disp(interpolar5);    
end
disp('para saber el trabajo del compresor-->1');
disp('para saber la potencia del evaporador-->2');
disp('para saber la potencia del condensador-->3');
   menu=input('');
if menu==1
    masico=input('digite el flujo masico en lbm/s');
    entalpia1=input('digite el valor de la entalpia del estado 1 en Btu/lbm');
    entalpia2=input('digite el valor de la entalpia del estado 2 en Btu/lbm');
disp('la potencia del compresor en kW es');
disp(masico*(entalpia2-entalpia1));
disp('copyright Daniel Almeida 2015');
elseif menu==2
     masico=input('digite el flujo masico en lbm/s');
     entalpia1=input('digite el valor de la entalpia del estado 1 en Btu/lbm');
     entalpia3=input('digite el valor de la entalpia del estado 3 en Btu/lbm');
  disp('la trasferencia de calor del evaporador es en kW'); 
  disp(masico*(entalpia1-entalpia3));
  disp('copyright Daniel Almeida 2015');
elseif menu==3
    masico=input('digite el flujo masico lbm/s');
    entalpia3=input('digite el valor de la entalpia del estado 3 en Btu/lbm');
    entalpia2=input('digite el valor de la entalpia del estado 2 en Btu/lbm');
    disp('la trasferencia de calor del condensador es en kW');
    disp(masico*(entalpia3-entalpia2));
  disp('copyright Daniel Almeida 2015');
end
disp('para saber el trabajo del compresor-->1');
disp('para saber la potencia del evaporador-->2');
...
elseif menu==2
     ...
     entalpia1=input('digite el valor de la entalpia del estado 1 en Btu/lbm');
     entalpia3=input('digite el valor de la entalpia del estado 3 en Btu/lbm');
  disp('la trasferencia de calor del evaporador es kW'); 
  disp(masico*(entalpia1-entalpia3));
  disp('copyright Daniel Almeida 2015');
elseif menu==3
    masico=input('digite el flujo masico lbm/s');
    entalpia3=input('digite el valor de la entalpia del estado 3 en Btu/lbm');
    entalpia2=input('digite el valor de la entalpia del estado 2 en Btu/lbm');
    disp('la trasferencia de calor del condensador es kW');
    disp(masico*(entalpia3-entalpia2));
  disp('copyright Daniel Almeida 2015');
end